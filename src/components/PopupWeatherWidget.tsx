      ...
      {isOpen && <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="bg-gradient-to-br from-[#1e1e1e]/95 to-[#2d2d30]/95 rounded-2xl border border-terminal-green/30 p-6 mx-4 max-w-md w-full shadow-2xl backdrop-blur-md animate-scale-in">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <button onClick={() => setIsOpen(false)} className="p-2 hover:bg-terminal-border/30 rounded-lg transition-colors">
            ...
            <div className="space-y-4">
              ...
              {/* Close Button */}
              <button onClick={() => setIsOpen(false)} className="w-full mt-6 p-3 bg-gradient-to-r from-terminal-green to-terminal-blue text-white rounded-lg hover:from-terminal-green/90 hover:to-terminal-blue/90 transition-all font-mono">
                Close
              </button>
            </div>
          </div>
